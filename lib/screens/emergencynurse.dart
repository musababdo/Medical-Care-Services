...
class EmergencyNurse extends StatefulWidget {
  static String id='EmergencyNurse';
  @override
  _EmergencyDoctorState createState() => _EmergencyDoctorState();
}

class _EmergencyDoctorState extends State<EmergencyNurse> {
  ...
  Future sendNow() async{
    ...
    var url = Uri.parse('https://h-o.sd/medicalcare/emergencynurse.php');
